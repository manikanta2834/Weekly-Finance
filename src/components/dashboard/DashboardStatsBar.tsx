  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-2.5 sm:gap-4">
        ...
        <div className="bg-[#061d1a]/90 border border-[#10332e] hover:border-[#1b433c] p-3.5 sm:p-5 rounded-2xl sm:rounded-3xl relative overflow-hidden transition-all shadow-xl group">
          <div className="flex items-center justify-between mb-1 sm:mb-2">
            <span className="text-[10px] sm:text-xs font-semibold text-[#8ba39e] truncate">
          ...
          <div className="text-base sm:text-2xl font-black text-[#e0e7e6] font-mono truncate">
            {formatINR(stats.totalPrincipalDisbursed)}
          </div>
          <div className="flex items-center gap-1 mt-1 sm:mt-2 text-[10px] sm:text-[11px] text-[#8ba39e]">
        ...
        <div className="bg-[#061d1a]/90 border border-emerald-500/30 hover:border-emerald-500/50 p-3.5 sm:p-5 rounded-2xl sm:rounded-3xl relative overflow-hidden transition-all shadow-xl group">
          <div className="flex items-center justify-between mb-1 sm:mb-2">
            <span className="text-[10px] sm:text-xs font-semibold text-emerald-300 truncate">
          ...
          <div className="text-base sm:text-2xl font-black text-emerald-300 font-mono truncate">
            {formatINR(stats.totalExpectedCollection)}
          </div>
          <div className="flex items-center gap-1 mt-1 sm:mt-2 text-[10px] sm:text-[11px] text-emerald-400/80">
        ...
        <div className="bg-[#061d1a]/90 border border-amber-500/30 hover:border-amber-500/50 p-3.5 sm:p-5 rounded-2xl sm:rounded-3xl relative overflow-hidden transition-all shadow-xl group">
          <div className="flex items-center justify-between mb-1 sm:mb-2">
          ...
          <div className="text-base sm:text-2xl font-black text-amber-300 font-mono truncate">
            +{formatINR(stats.totalInterestEarned)}
          </div>
          <div className="flex items-center gap-1 mt-1 sm:mt-2 text-[10px] sm:text-[11px] text-amber-400/80">
        ...
        <div className="bg-[#061d1a]/90 border border-[#10332e] hover:border-[#1b433c] p-3.5 sm:p-5 rounded-2xl sm:rounded-3xl relative overflow-hidden transition-all shadow-xl group">
          ...
          <div className="flex items-center justify-between mt-1 sm:mt-2 text-[10px] sm:text-[11px]">
      ...
      <div className="bg-[#061d1a]/80 border border-[#10332e] rounded-2xl p-4 flex flex-col sm:flex-row items-center justify-between gap-4">
        <div className="flex items-center gap-3 w-full sm:w-auto">
          ...
          <div>
            <span className="text-xs font-bold text-[#e0e7e6] block">
              Master Ledger Cashflow Progress
            </span>
            <span className="text-[11px] text-[#8ba39e] font-mono">
        ...
        <div className="w-full sm:w-72 space-y-1">
          <div className="w-full bg-[#020d0c] h-3 rounded-full overflow-hidden p-0.5 border border-[#10332e]">
            <div
